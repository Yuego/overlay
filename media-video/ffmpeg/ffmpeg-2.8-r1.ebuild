...
FFMPEG_ENCODER_FLAG_MAP=(
	aac:libvo-aacenc amrenc:libvo-amrwbenc mp3:libmp3lame nvenc:nvenc
	aacplus:libaacplus faac:libfaac snappy:libsnappy theora:libtheora twolame:libtwolame
	wavpack:libwavpack webp:libwebp x264:libx264 x265:libx265 xvid:libxvid
)

IUSE="
	alsa +encode examples jack oss pic static-libs test v4l nvenc
	${FFMPEG_FLAG_MAP[@]%:*}
	${FFMPEG_ENCODER_FLAG_MAP[@]%:*}
"
...
RDEPEND="
	...
	encode? (
		...
		snappy? ( >=app-arch/snappy-1.1.2-r1[${MULTILIB_USEDEP}] )		theora? (
		...
		nvenc? ( >=x11-drivers/nvidia-drivers-346.22 )
