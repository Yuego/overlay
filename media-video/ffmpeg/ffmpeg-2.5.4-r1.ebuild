...
IUSE="
	...
	jpeg2k ladspa libass libcaca nvenc libsoxr libv4l lzma modplug mp3 +network
...
RDEPEND="
	...
	encode? (
		...
		nvenc? ( >=dev-util/nvidia-cuda-sdk-6.5[${MULTILIB_USEDEP}] )
		theora? (
...
multilib_src_configure() {
	...
	then
		...
		for i in aacplus faac nvenc theora twolame wavpack webp x264 x265 xvid; do
			ffuse+=( ${i}:lib${i} )
		done
